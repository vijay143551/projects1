...
t1 = train('Arrakonam',12345,'12:34','22:12','tpt','kdp','Wed',30,23,43,2205,320,234)
...
u1 = user(1234,'vishal','cuttack','7997274738','vijay')
u2 = user(5121,'alex parrish','new york','7997274738','alexparrish')
...
def s():
    filename = "/tmp/not_exist/data.pkl"
...
print("--------------------------------------------------Welcome to TRCTC Reservation Portal----------------------------------------------")
print("-------------------------------------------------------------------------------------------------------------------------------------")
load()
